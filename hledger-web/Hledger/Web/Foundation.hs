...
|]
    ...
    isAuthorized (AuthR _)  _ = return Authorized       -- anyone can log in
    isAuthorized _          _ = isUser                  -- must be logged in for all other areas
